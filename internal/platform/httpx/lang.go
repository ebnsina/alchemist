...
var bangla = map[string]string{
	...
	"invalid_limit":           "একবারে ১ থেকে ১০০টির মধ্যে চান।",
	"invalid_offset":          "০ বা তার বড় পূর্ণসংখ্যা থেকে শুরু করুন।",
	"invalid_sort":            "এই তালিকা এভাবে সাজানো যায় না।",
	"invalid_order":           "asc অথবা desc দিন।",
	"invalid_filter":          "ফিল্টারটি true অথবা false হতে হবে।",
	"invalid_title":           "নামটি খুব বড়। ২০০ অক্ষরের মধ্যে রাখুন।",
	"webhook_not_found":       "এই ওয়েবহুকটি খুঁজে পাওয়া যায়নি।",
	"bucket_not_found":        "এই বাকেটটি খুঁজে পাওয়া যায়নি।",
	"bucket_in_use":           "এই বাকেট থেকে আসা ভিডিও এখনও প্রসেস হচ্ছে। শেষ হলে সরানো যাবে।",
	"key_not_found":           "এই কী টি খুঁজে পাওয়া যায়নি।",
	...
	"invalid_language":        "bn, en বা bn-BD এর মতো একটি ভাষা কোড দিন।",
	"invalid_label":           "নামটি ৬০ অক্ষরের মধ্যে রাখুন — এটি প্লেয়ারের মেনুতে দেখাবে।",
	"invalid_captions":        "এটি WebVTT ফাইল নয়। ফাইলটি WEBVTT শব্দ দিয়ে শুরু হতে হবে।",
	"caption_too_large":       "সাবটাইটেল ফাইলটি ২ MB এর বেশি।",
	"caption_not_found":       "এই ভাষায় কোনো সাবটাইটেল নেই।",
	...
	"invalid_origin":          "সাইটের ঠিকানা https://app.example.com এর মতো হতে হবে।",
	"origin_not_allowed":      "এই অ্যাকাউন্টে এই সাইটে ভিডিও চালানোর অনুমতি নেই।",
	"invalid_ttl":             "লিংকের মেয়াদ ৬০ সেকেন্ড থেকে ২৪ ঘণ্টার মধ্যে হতে হবে।",
	...
	"stream_on_air":           "এই স্ট্রিমটি এখন চলছে। আগে বন্ধ করুন, তারপর মুছুন।",
	"invalid_protocol":        "ক্যামেরা, srt অথবা rtmp বেছে নিন।",
