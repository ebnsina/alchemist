...
<Seo
	title="Alchemist for course platforms"
	description="Lectures that play on a cheap phone without stalling, that do not drain a student's data, and that cannot simply be downloaded and passed around."
/>
